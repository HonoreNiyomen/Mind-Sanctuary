...
#
#     PHX_SERVER=true bin/mind_sanctuary start
#
...
if config_env() == :prod do
  ...
  config :mind_sanctuary, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :mind_sanctuary, MindSanctuary.Mailer,
