defmodule MindSanctuaryWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: MindSanctuaryWeb.Gettext
    ...
    >
      ...
      >
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-1 sm:p-3 lg:py-4">
            <.focus_wrap
              id={"#{@id}-container"}
              phx-window-keydown={JS.exec("data-cancel", to: "##{@id}")}
              phx-key="escape"
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-white overflow-hidden shadow-lg ring-1 transition"
            >
              <div id={"#{@id}-content"}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MindSanctuaryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MindSanctuaryWeb.Gettext, "errors", msg, opts)
    end
  end
