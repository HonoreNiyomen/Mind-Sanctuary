defmodule MindSanctuary.Mood.Entry do
  ...
  def changeset(entry, attrs) do
    ...
    |> validate_number(:energy_level, greater_than_or_equal_to: 1, less_than_or_equal_to: 10, message: "must be between 1 and 10")
    |> validate_number(:stress_level, greater_than_or_equal_to: 1, less_than_or_equal_to: 10, message: "must be between 1 and 10")
    |> validate_number(:sleep_hours, greater_than_or_equal_to: 0, less_than_or_equal_to: 24, message: "must be between 0 and 24")
